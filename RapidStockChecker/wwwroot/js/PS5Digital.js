...
const alarm = 'alarmPS5Digital';
const alarmType = 'alarmTypePS5Digital';
...
signalrConnection.start().then(res => {
    signalrConnection.invoke("JoinGroup", "PlayStation5Digital")
        .catch(err => {
            console.log(err);
        });
}).catch(err => {
...
signalrConnection.on("PlayStation5DigitalAlertTrigger", function (products) {
