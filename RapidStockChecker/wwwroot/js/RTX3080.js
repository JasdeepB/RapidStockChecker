...
const alarm = 'alarmRTX3080';
const alarmType = 'alarmTypeRTX3080';
...
signalrConnection.start().then(res => {
    signalrConnection.invoke("JoinGroup", "NVIDIAGeForceRTX3080")
        .catch(err => {
            console.log(err);
        });
}).catch(err => {
...
signalrConnection.on("NVIDIAGeForceRTX3080AlertTrigger", function (products) {
