...
const alarm = 'alarmSwitchOLED';
const alarmType = 'alarmTypeSwitchOLED';
...
signalrConnection.start().then(res => {
    signalrConnection.invoke("JoinGroup", "NintendoSwitchOLED")
        .catch(err => {
            console.log(err);
        });
}).catch(err => {
...
signalrConnection.on("NintendoSwitchOLEDAlertTrigger", function (products) {
