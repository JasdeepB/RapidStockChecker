...
const alarm = 'alarmRX6800';
const alarmType = 'alarmTypeRX6800';
...
signalrConnection.start().then(res => {
    signalrConnection.invoke("JoinGroup", "AMDRadeon6800")
        .catch(err => {
            console.log(err);
        });
}).catch(err => {
...
signalrConnection.on("AMDRadeon6800AlertTrigger", function (products) {
