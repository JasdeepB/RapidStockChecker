...
const alarm = 'alarmRTX3060Ti';
const alarmType = 'alarmTypeRTX3060Ti';
...
signalrConnection.start().then(res => {
    signalrConnection.invoke("JoinGroup", "NVIDIAGeForceRTX3060Ti")
        .catch(err => {
            console.log(err);
        });
}).catch(err => {
...
signalrConnection.on("NVIDIAGeForceRTX3060TiAlertTrigger", function (products) {
