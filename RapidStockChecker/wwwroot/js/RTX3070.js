...
const alarm = 'alarmRTX3070';
const alarmType = 'alarmTypeRTX3070';
...
signalrConnection.start().then(res => {
    signalrConnection.invoke("JoinGroup", "NVIDIAGeForceRTX3070")
        .catch(err => {
            console.log(err);
        });
}).catch(err => {
...
signalrConnection.on("NVIDIAGeForceRTX3070AlertTrigger", function (products) {
