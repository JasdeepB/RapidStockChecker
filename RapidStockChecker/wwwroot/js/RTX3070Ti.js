...
const alarm = 'alarmRTX3070Ti';
const alarmType = 'alarmTypeRTX3070Ti';
...
signalrConnection.start().then(res => {
    signalrConnection.invoke("JoinGroup", "NVIDIAGeForceRTX3070Ti")
        .catch(err => {
            console.log(err);
        });
}).catch(err => {
...
signalrConnection.on("NVIDIAGeForceRTX3070TiAlertTrigger", function (products) {
